...
async def echo_handler(message: Message):
    ...
    if text.lower() == 'привет':
        ...
        await message.answer(
                'Я могу:\n'
                '— показать товары,\n'
                '— подсказать, где их можно приобрести,\n'
                '— сам оформить заказ,\n'
                '— научить заваривать разные сорта чая,\n'
                '— помочь оставить отзыв,\n'
                '— и многое другое!\n'

                'Пиши — я отвечу.\n'

                '⚠️ Обращаю ваше внимание:\n'
                'Заказы отправляются через СДЭК наложным платежом.\n'
                'Сумму доставки рассчитывает администратор'
